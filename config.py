...
ROLIMONS_TRADE_AD_ADMISSION_WINDOW_SECONDS = int(
    os.getenv("ROLIMONS_TRADE_AD_ADMISSION_WINDOW_SECONDS", "86400")
)
ROLIMONS_TRADE_AD_ADMISSION_MIN_ADS = int(
    os.getenv("ROLIMONS_TRADE_AD_ADMISSION_MIN_ADS", "3")
)
ROLIMONS_TRADE_AD_ADMISSION_MIN_OFFER_VALUE = int(
    os.getenv("ROLIMONS_TRADE_AD_ADMISSION_MIN_OFFER_VALUE", "100000")
)
ROLIMONS_TRADE_AD_ADMISSION_MAX_USERS = int(
    os.getenv("ROLIMONS_TRADE_AD_ADMISSION_MAX_USERS", "500")
)
ROLIMONS_TRADE_AD_ASSET_MIN_OFFERS = int(
    os.getenv("ROLIMONS_TRADE_AD_ASSET_MIN_OFFERS", "3")
)
ROLIMONS_TRADE_AD_MAX_PRIORITY_ASSETS = int(
...
LEARNED_VALUE_RECENCY_HALF_LIFE_DAYS = float(
    os.getenv("LEARNED_VALUE_RECENCY_HALF_LIFE_DAYS", "14")
)
LEARNED_VALUE_PROOF_EXECUTABILITY_WEIGHT = float(
    os.getenv("LEARNED_VALUE_PROOF_EXECUTABILITY_WEIGHT", "0.50")
)
LEARNED_VALUE_VERIFIED_EXECUTABILITY_WEIGHT = float(
    os.getenv("LEARNED_VALUE_VERIFIED_EXECUTABILITY_WEIGHT", "0.85")
)
